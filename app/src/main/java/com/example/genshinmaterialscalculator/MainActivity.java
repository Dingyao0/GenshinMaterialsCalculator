...
//                1, 1, 1, 1, 1));
        db.addCharacter(new Character("Amber", "fire", "Bow", "793", "19", "50", R.drawable.atk_pct, "0", "12",
                ...
                "Always energetic and full of life, Amber's the best — albeit only — Outrider of the Knights of Favonius.", "regio", R.drawable.w_2313, R.drawable.w_2313, R.drawable.w_2313,
                1, 1, 1, 1, 1));
        db.addCharacter(new Character("Arataki Itto", "fire", "Claymore", "1001", "18", "75", R.drawable.cr, "5", "12",
                ...
                " The first and greatest head of the Arataki Gang, famed throughout Inazuma City's Hanamizaka... Wait, what? You've never heard of them? Are you trying to be funny here?", "regio", R.drawable.w_2313, R.drawable.w_2313, R.drawable.w_2313,
                1, 1, 1, 1, 1));
        ...
        db.addCharacter(new Character("Hu Tao", "fire", "Polearm", "1211", "8", "68", R.drawable.cd, "50", "12",
                ...
                " The 77th Director of the Wangsheng Funeral Parlor. She took over the business at a rather young age.", "regio", R.drawable.w_2313, R.drawable.w_2313, R.drawable.w_2313,
                1, 1, 1, 1, 1));
        ...
        db.addCharacter(new Character("Raiden Shogun", "fire", "Polearm", "1005", "26", "61", R.drawable.em, "0", "12",
                ...
                " Her Excellency, the Almighty Narukami Ogosho, who promised the people of Inazuma an unchanging Eternity.", "regio", R.drawable.w_2313, R.drawable.w_2313, R.drawable.w_2313,
                1, 1, 1, 1, 1));
        db.addCharacter(new Character("Rosaria", "fire", "Polearm", "1030", "20", "60", R.drawable.atk_pct, "0", "12",
                ...
                " A sister of the church, though you wouldn't know it if it weren't for her attire. Known for her sharp, cold words and manner, she often works alone..", "regio",R.drawable.w_2313, R.drawable.w_2313, R.drawable.w_2313,
                1, 1, 1, 1, 1));
        db.addCharacter(new Character("Sangonomiya Kokomi", "fire", "Catalyst", "1049", "18", "51", R.drawable.atk_pct, "0", "12",
                ...
                " The Divine Priestess of Watatsumi Island. All of the island's affairs are at this young lady's fingertips.", "regio",R.drawable.w_2313, R.drawable.w_2313, R.drawable.w_2313,
                1, 1, 1, 1, 1));
